...
//        $(".menuimage > img").addClass("grayscale");
//        $(".captiontext").css("opacity", 1);
//    }
//});
...
function PopcornLink() {
    window.location.href = "Popcorn";
}
function StiftelseLink() {
    window.location.href = "http://www.stiftelseverket.se/";
}
...
$(document).ready(function () {
    $("#titlebox").hover(
        function () {
            $(".headertitle", this).css('font-weight', "bolder");
        },
        function () {
            $(".headertitle", this).css('font-weight', "unset");
        }
    );
});
